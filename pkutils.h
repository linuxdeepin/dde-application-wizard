...
namespace PKUtils {
    ...
    QCoro::Task<PkPackages> searchFiles(const QString & search, PackageKit::Transaction::Filters filters = PackageKit::Transaction::FilterNone);
    ...
    QCoro::Task<void> removePackage(const QString & packageId);
}
